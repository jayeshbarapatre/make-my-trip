...
// Theme Colors - DEPRECATED: Use DaisyUI tokens instead
// bg-primary, text-primary-content, bg-success, text-success-content, etc.
// For inline styles use: hsl(var(--p)), hsl(var(--s)), hsl(var(--su)), hsl(var(--er))

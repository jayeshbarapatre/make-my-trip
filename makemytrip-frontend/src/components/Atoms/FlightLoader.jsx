      ...
      <div className="flight-loader-plane-wrapper">
        ...
        >
          ...
          <path 
            ...
            fill="hsl(var(--bc) / 0.65)" 
          />
          {/* Row of passenger cabin windows */}
          <circle cx="64" cy="43" r="3" fill="hsl(var(--bc) / 0.65)" />
          <circle cx="76" cy="43" r="3" fill="hsl(var(--bc) / 0.65)" />
          <circle cx="88" cy="43" r="3" fill="hsl(var(--bc) / 0.65)" />
          <circle cx="100" cy="43" r="3" fill="hsl(var(--bc) / 0.65)" />
          <circle cx="112" cy="43" r="3" fill="hsl(var(--bc) / 0.65)" />
          <circle cx="124" cy="43" r="3" fill="hsl(var(--bc) / 0.65)" />
          <circle cx="136" cy="43" r="3" fill="hsl(var(--bc) / 0.65)" />

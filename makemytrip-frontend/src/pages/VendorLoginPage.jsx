...
import { RiStoreLine, RiMailLine, RiLockLine, RiEyeLine, RiEyeOffLine } from 'react-icons/ri'
    ...
    <div className="min-h-screen bg-base-200 flex items-center justify-center p-4">
      <div className="w-full max-w-sm">
        ...
        <div className="flex flex-col items-center mb-8">
          <div className="w-14 h-14 rounded-2xl bg-secondary flex items-center justify-center mb-4 shadow-lg">
            <RiStoreLine className="w-7 h-7 text-secondary-content" />
          </div>
          <h1 className="text-2xl font-bold text-base-content">Vendor Portal</h1>
        ...
        <p className="text-center text-xs text-base-content/40 mt-6">
          Secure vendor access · MakeMyTrip Platform
        </p>
      </div>
    </div>
  )

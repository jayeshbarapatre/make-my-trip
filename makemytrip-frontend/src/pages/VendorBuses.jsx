      ...
      <div style={{ padding: '0 0 24px' }}>
        ...
        {buses.length === 0 ? (
          <div className="card" style={{ padding: '60px 20px', textAlign: 'center' }}>
            ...
            <button className="btn btn-primary" onClick={() => { setEditingBusId(null); setShowFormModal(true); }}>
              ...
              <div key={bus.id} className="card" style={{ display: 'flex', flexDirection: 'column' }}>
                <div className="card-body" style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: '16px', padding: '24px' }}>
                  ...
                  <div style={{ display: 'flex', gap: '8px', flexWrap: 'wrap', marginTop: 'auto' }}>
                    <button className="btn btn-sm" onClick={() => { setEditingBusId(bus.id || bus._id); setShowFormModal(true); }} style={{ flex: 1, display: 'flex', gap: '6px', justifyContent: 'center', alignItems: 'center' }}>

              ...
              <div key={hotel.id} className="card" style={{ display: 'flex', flexDirection: 'column' }}>
                <div className="card-body" style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: '16px', padding: '24px' }}>
                  ...
                  <div style={{ display: 'flex', gap: '8px', flexWrap: 'wrap', marginTop: 'auto' }}>
                    <button className="btn btn-sm" onClick={() => { setEditingHotelId(hotel.id); setShowFormModal(true); }} style={{ flex: 1, display: 'flex', gap: '6px', justifyContent: 'center', alignItems: 'center' }}>
                      <i className="fas fa-edit" style={{ opacity: 0.7 }}></i> Edit
                    </button>
                    <button className="btn btn-sm" onClick={() => navigate(`/vendor/hotels/${hotel.id}/rooms`)} style={{ flex: 1, display: 'flex', gap: '6px', justifyContent: 'center', alignItems: 'center' }}>
                      <i className="fas fa-door-open" style={{ opacity: 0.7 }}></i> Rooms
                    </button>
                  </div>

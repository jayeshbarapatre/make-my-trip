        ...
        {flights.length === 0 ? (
          <div className="card" style={{ padding: '60px 20px', textAlign: 'center' }}>
            <div style={{ width: '64px', height: '64px', borderRadius: '50%', background: 'var(--surface2)', display: 'flex', alignItems: 'center', justifyContent: 'center', margin: '0 auto 16px', border: '1px solid var(--border)' }}>
              <i className="fas fa-plane" style={{ fontSize: '24px', color: 'var(--text-muted)' }}></i>
            </div>
            <h3 style={{ fontSize: '18px', fontWeight: 600, color: 'var(--text-primary)', margin: '0 0 8px' }}>No flights found</h3>
            <p style={{ color: 'var(--text-secondary)', margin: '0 0 24px', fontSize: '14px' }}>You haven't listed any flights yet. Get started by adding your first route.</p>
            <button className="btn btn-primary" onClick={() => { setEditingFlightId(null); setShowFormModal(true); }} style={{ width: 'fit-content', margin: '0 auto' }}>
              <i className="fas fa-plus" style={{ marginRight: '8px' }}></i> Add New Flight
            </button>
          </div>
        ) : (
